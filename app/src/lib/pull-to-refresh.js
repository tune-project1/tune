  ...
  function _onTouchMove(e) {
    ...
    if (_shared.distExtra > 0) {
      ...
      _shared.distResisted =
        _el.resistanceFunction(_shared.distExtra / _el.distThreshold) * Math.min(_el.distMax, _shared.distExtra);
...
var _setupHandler = function (options) {
  ...
  _handler.refreshTimeout =
    typeof options.refreshTimeout === "number" ? options.refreshTimeout : _defaults.refreshTimeout; // normalize elements
