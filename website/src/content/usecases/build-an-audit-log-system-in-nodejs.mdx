...
5. Install the Nodejs SDK for Tune
```bash
...
Pepper calls to the Tune SDK in your code.
...
Learn more at https://tune and try out ready-to-paste code snippets in our [playground](https://tune/playground).