...
- Not any throwaway email provider to register(eg mailinator). Throwaway emails are explicitly prohibited and using throwaway email providers are against Tune’s terms.
