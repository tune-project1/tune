...
This is the fasted method to install Tune. This method requires that
...
Once configured, run `curl -fsSL https://raw.githubusercontent.com/tune-co/tune/master/bin/setup-vps.sh | sudo bash
...
These are the steps you need to follow if you want to install Tune manually.
